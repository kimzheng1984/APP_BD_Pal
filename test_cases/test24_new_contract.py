...
class BD(unittest.TestCase):
    ...
    def test13_mch_new_contract(self):
        # xpath以index来定位控件
        ...
        time.sleep(2)
        self.driver.find_element_by_id("com.nuanyou.bdpal:id/tv_dialog_new_and_relation_contract").click()
        time.sleep(5)
        self.driver.get_screenshot_as_file("C:\\WORK\\workspace\\python\\report\\BD\\mch_new_contract.jpg")
        time.sleep(1)
        self.driver.find_element_by_xpath("//android.widget.LinearLayout[@index=1]").click()
        time.sleep(1)
        self.driver.find_element_by_id("com.nuanyou.bdpal:id/tv_confirm_relate").click()
        time.sleep(1)
