...
class BD(unittest.TestCase):
    ...
    def test_ger(self):
        ...
        time.sleep(2)
        # 韩文
        self.driver.find_element_by_id("com.nuanyou.bdpal:id/ll_german").click()
        time.sleep(2)
        self.driver.get_screenshot_as_file("C:\\WORK\\workspace\\python\\report\\BD\\ger.jpg")
        time.sleep(2)
        # 演示资料页面检查
        ...
        time.sleep(3)
        self.driver.get_screenshot_as_file("C:\\WORK\\workspace\\python\\report\\BD\\ger1.jpg")
        time.sleep(2)
        ...
        time.sleep(3)
        self.driver.get_screenshot_as_file("C:\\WORK\\workspace\\python\\report\\BD\\ger2.jpg")
        time.sleep(2)
        ...
        time.sleep(5)
        self.driver.get_screenshot_as_file("C:\\WORK\\workspace\\python\\report\\BD\\ger3.jpg")
        time.sleep(1)
        self.driver.find_element_by_id("com.nuanyou.bdpal:id/ll_add_merchant").click()
        time.sleep(2)
        self.driver.get_screenshot_as_file("C:\\WORK\\workspace\\python\\report\\BD\\ger4.jpg")
        time.sleep(1)
        ...
        time.sleep(5)
        self.driver.get_screenshot_as_file("C:\\WORK\\workspace\\python\\report\\BD\\ger5.jpg")
        time.sleep(1)
        self.driver.find_element_by_id("com.nuanyou.bdpal:id/tv_new_contract").click()
        time.sleep(3)
        self.driver.get_screenshot_as_file("C:\\WORK\\workspace\\python\\report\\BD\\ger6.jpg")
        time.sleep(2)
