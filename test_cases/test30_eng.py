...
class BD(unittest.TestCase):
    ...
    def test_eng(self):
        ...
        time.sleep(2)
        # 韩文
        self.driver.find_element_by_id("com.nuanyou.bdpal:id/ll_english").click()
        time.sleep(2)
        self.driver.get_screenshot_as_file("C:\\WORK\\workspace\\python\\report\\BD\\eng.jpg")
        time.sleep(2)
        # 演示资料页面检查
        ...
        time.sleep(3)
        self.driver.get_screenshot_as_file("C:\\WORK\\workspace\\python\\report\\BD\\eng1.jpg")
        time.sleep(2)
        ...
        time.sleep(3)
        self.driver.get_screenshot_as_file("C:\\WORK\\workspace\\python\\report\\BD\\eng2.jpg")
        time.sleep(2)
        ...
        time.sleep(5)
        self.driver.get_screenshot_as_file("C:\\WORK\\workspace\\python\\report\\BD\\eng3.jpg")
        time.sleep(1)
        self.driver.find_element_by_id("com.nuanyou.bdpal:id/ll_add_merchant").click()
        time.sleep(2)
        self.driver.get_screenshot_as_file("C:\\WORK\\workspace\\python\\report\\BD\\eng4.jpg")
        time.sleep(1)
        ...
        time.sleep(5)
        self.driver.get_screenshot_as_file("C:\\WORK\\workspace\\python\\report\\BD\\eng5.jpg")
        time.sleep(1)
        self.driver.find_element_by_id("com.nuanyou.bdpal:id/tv_new_contract").click()
        time.sleep(3)
        self.driver.get_screenshot_as_file("C:\\WORK\\workspace\\python\\report\\BD\\eng6.jpg")
        time.sleep(2)
