...
class BD(unittest.TestCase):
    ...
    def test_thai(self):
        ...
        time.sleep(2)
        # 韩文
        self.driver.find_element_by_id("com.nuanyou.bdpal:id/ll_thai").click()
        time.sleep(2)
        self.driver.get_screenshot_as_file("C:\\WORK\\workspace\\python\\report\\BD\\thai.jpg")
        time.sleep(2)
        # 演示资料页面检查
        ...
        time.sleep(3)
        self.driver.get_screenshot_as_file("C:\\WORK\\workspace\\python\\report\\BD\\thai1.jpg")
        time.sleep(2)
        ...
        time.sleep(3)
        self.driver.get_screenshot_as_file("C:\\WORK\\workspace\\python\\report\\BD\\thai2.jpg")
        time.sleep(2)
        ...
        time.sleep(5)
        self.driver.get_screenshot_as_file("C:\\WORK\\workspace\\python\\report\\BD\\thai3.jpg")
        time.sleep(1)
        self.driver.find_element_by_id("com.nuanyou.bdpal:id/ll_add_merchant").click()
        time.sleep(2)
        self.driver.get_screenshot_as_file("C:\\WORK\\workspace\\python\\report\\BD\\thai4.jpg")
        time.sleep(1)
        ...
        time.sleep(5)
        self.driver.get_screenshot_as_file("C:\\WORK\\workspace\\python\\report\\BD\\thai5.jpg")
        time.sleep(1)
        self.driver.find_element_by_id("com.nuanyou.bdpal:id/tv_new_contract").click()
        time.sleep(3)
        self.driver.get_screenshot_as_file("C:\\WORK\\workspace\\python\\report\\BD\\thai6.jpg")
        time.sleep(2)
